...
# original objectives, and the unconstrained problem additionally folds the constraints into an
# aggregated violation objective, while the constrained problem exposes them as constraints.
...
_PROBLEM_INFO_TABLE: list[_ProblemInfo] = [
    _ProblemInfo("RE21", None, ("f1_structural_volume", "f2_joint_displacement"), ()),
    _ProblemInfo("RE22", None, ("f1_total_cost",), (1, 2)),
    _ProblemInfo("RE23", None, ("f1_total_cost",), (1, 2, 3)),
    _ProblemInfo("RE24", None, ("f1_weight",), (1, 2, 3, 4)),
    _ProblemInfo("RE25", None, ("f1_volume",), (1, 2, 3, 4, 5, 6)),
    _ProblemInfo(
        "RE31",
        "CRE21",
    ...
    _ProblemInfo("RE32", "CRE22", ("f1_cost", "f2_end_deflection"), (1, 2, 3, 4)),
    _ProblemInfo("RE33", "CRE23", ("f1_brake_mass", "f2_minimum_stopping_time"), (1, 2, 3, 4)),
    _ProblemInfo(
        "RE34",
        None,
    ...
    _ProblemInfo("RE36", "CRE25", ("f1_gear_ratio_error", "f2_max_gear_size"), (1,)),
    _ProblemInfo(
        "RE37",
        None,
        (
